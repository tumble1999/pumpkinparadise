var BoxCritters = (function() {
	...
	function Artwork(t) {
		this.background,
			this.foreground,
			(this.character = this.createCharacterSprite(t.character)),
			t.roomPath
				? (this.roomPath = t.roomPath)
	...
	(Artwork.prototype.createCharacterSprite = function(t) {
		...
		return (
			...
			(e.balloonX = t.balloonX),
			(e.balloonY = t.balloonY),
			e
		);
	}),
		(Player.prototype = Object.create(createjs.Container.prototype)),
		(Player.prototype.setCharacter = function(t) {
			"function" == typeof (this.character = t).gotoAndPlay &&
				(this.hasFrames = !0);
		}),
	...
	function Room(t, o, e) {
		if (
			...
			e.artwork &&
				e.artwork.sprites &&
				((e.artwork.sprites.images[0] =
					this.artwork.roomPath + e.artwork.sprites.images[0]),
